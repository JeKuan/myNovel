...
def bind_email(request):
    ...
    context = {}
    context['form'] = form
    context['page_title'] = '綁定郵箱'
    context['form_title'] = '綁定郵箱'
...
def send_verification_code(request):
    ...
    if email != '':
        ...
        if now - send_code_time < 30:
            ...
            #發送郵件
            send_mail('我的小說網郵箱驗證碼確認',
            '驗證碼：' + code,
            'supereason1210@gmail.com',
            [email],
            fail_silently=False,
            )
            data['status'] = 'SUCCESS'
...
def forgot_password(request):
    ...
    context = {}
    context['form'] = form
    context['page_title'] = '忘記密碼'
    context['form_title'] = '忘記密碼'
